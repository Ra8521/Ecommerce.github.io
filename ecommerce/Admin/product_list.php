		 ...
		 <div class="heading">
			...
			<table class="table">
				...
				for($i=0;$i<$num;$i++){
					...
					echo "<td><a href=\"delete_product.php?id=".$array['product_id']."\" class=\"btn btn-danger btn-xs\">Delete</a>
					&nbsp <a href=\"edit_product.php?id=".$array['product_id']."\" class=\"btn btn-warning btn-xs\">Edit</a> 
					</td>";
					echo "<tr>";
					$counter++;
